...
namespace zgui {
    ...
    namespace globals {
        ...
        static struct {
          color window_border_inner_fill{ 19, 19, 19, 255};
          color window_border_fill{ 19, 19, 19, 255};
          color window_border_color{0, 218, 255, 92};
          color window_background{31, 31, 31, 255};

          color control_outline{0, 0, 0, 255};
          color control_active_or_clicked{0, 241, 255, 130};
          color control_idle{ 19, 19, 19, 255};

          color color_groupbox_bg{50, 50, 50, 255};
          color color_text{203, 203, 203, 255};
          color color_text_dimmer{99, 110, 114, 255};
          color color_slider{0, 79, 255, 181};
          color color_combo_bg{141, 0, 255, 85};
    ...
    ZGUI_API void poll_input(HWND hwnd, int w, int h);
    ...
    ZGUI_API void begin_groupbox(std::string_view title, vec2 size, int flags);
    ...
    //Pasted from https://github.com/Yang-zhiyuan/gamerwarev2.5/tree/master, just a bit modified to fit my needs 
    ZGUI_API void color_picker(const char* id, color& value, int box_offset = 50) noexcept;
    ZGUI_API void begin_groupbox(std::string_view title, const vec2 size) noexcept;
